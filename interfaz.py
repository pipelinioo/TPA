...
class MyMainWindow(QMainWindow):
    def __init__(self):
        ...
        # Crear la sección superior de la ventana
        ...
        # Crear la sección central de la ventana
        ...
        # Crear la sección inferior de la ventana
        ...
        # Agregar todas las secciones a la ventana principal
